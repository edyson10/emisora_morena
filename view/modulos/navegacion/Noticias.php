    ...
    <div class="container-fluid">
        ...
        <div class="col-12 tm-carousel">
          <div class="tm-bg-black-transparent tm-testimonial-box text-center">
            <div class="tm-person-img-container">
              <img src="view/presentacion/img/person-1.png" alt="Image" class="img-fluid mx-auto" />
            </div>
          ...
          <div class="tm-bg-black-transparent tm-testimonial-box text-center">
            <div class="tm-person-img-container">
              <img src="view/presentacion/img/person-2.png" alt="Image" class="img-fluid mx-auto" />
            </div>
          ...
          <div class="tm-bg-black-transparent tm-testimonial-box text-center">
            <div class="tm-person-img-container">
              <img src="view/presentacion/img/person-3.png" alt="Image" class="img-fluid mx-auto" />
            </div>
      ...
      <section class="row tm-testimonials-cta" id="tmCallToAction">
        <div class="col-12 tm-call-to-action-col">
          <img src="view/presentacion/img/call-to-action-2.jpg" alt="Image" class="img-fluid tm-call-to-action-image" />
